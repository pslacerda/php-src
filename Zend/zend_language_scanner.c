...
yyc_ST_VAR_OFFSET:
	{
		...
		if (yych <= '0') {
			if (yych <= ' ') {
				if (yych <= '\f') {
					if (yych <= 0x08) goto yy829;
					if (yych <= '\n') goto yy825;
					goto yy829;
				} else {
					if (yych <= '\r') goto yy825;
					if (yych <= 0x1F) goto yy829;
					goto yy825;
				}
			} else {
				if (yych <= '$') {
